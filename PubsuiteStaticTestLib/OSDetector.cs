...
namespace PubsuiteStaticTestLib
{
    public class OSDetector
    {
        ...
        private static readonly string osServerASZOS24H2 = "Microsoft server operating system version 24H2";

        private static readonly string osWinSV21H2 = "Windows 11";
        private static readonly string osWin1122H2 = "Windows 11, version 22H2";
        private static readonly string osWin1123H2 = "Windows 11, version 23H2";
        private static readonly string osWin1124H2 = "Windows 11, version 24H2";
        ...
        public static string ParseTargetOSFromUpdateTitle(string title)
        {
            ...
            if (title.Contains(osWin1123H2))
                return osWin1123H2;

            if (title.Contains(osWin1124H2))
                return osWin1124H2;
            ...
            if (title.Contains(osServerASZOS24H2))
                return osServerASZOS24H2;
