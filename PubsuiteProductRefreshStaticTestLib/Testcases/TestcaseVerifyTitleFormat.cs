...
namespace PubsuiteProductRefreshStaticTestLib.Testcases
{
    class TestcaseVerifyTitleFormat : TestcaseBase
    {
        ...
        private void BuildOSLookupTable()
        {
            ...
            _osNameLookupTable.Add("Microsoft server operating system version 21H2", "2022;Windows Server 2022;21H2");
            _osNameLookupTable.Add("Microsoft server operating system, version 22H2", "2022;Windows Server 2022;21H2");
        ...
        {
            //return "Microsoft .NET Framework 4.8.1";
