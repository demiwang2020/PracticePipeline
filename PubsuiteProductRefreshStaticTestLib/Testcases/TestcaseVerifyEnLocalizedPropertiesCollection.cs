...
namespace PubsuiteProductRefreshStaticTestLib.Testcases
{
    ...
    {
        public TestcaseVerifyEnLocalizedPropertiesCollection(InputData inputData, Update expectUpdate, Update actualUpdate)
        ...
        protected override void RunTest()
        {
            ...
            if (!_actualUpdate.SupportUrl.Equals(_expectedUpdate.SupportUrl))
            {
                _result.Result = false;
            ...
            if (!_actualUpdate.MoreInfoUrl.Equals(_expectedUpdate.MoreInfoUrl))
            {
                _result.Result = false;
